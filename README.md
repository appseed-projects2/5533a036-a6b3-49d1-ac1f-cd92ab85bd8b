...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-06 23:49`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5533a036-a6b3-49d1-ac1f-cd92ab85bd8b.git
$ cd 5533a036-a6b3-49d1-ac1f-cd92ab85bd8b
```
